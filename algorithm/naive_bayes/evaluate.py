...
def main():
    ...
    matrix_path = OUTPUT_DIR / "confusion_matrix_2_labels.svg"

    write_report(report_path, report_lines)
    matrix_path.write_text(
        matrix_to_svg(matrix, "Naive Bayes Sentiment Confusion Matrix"),
        encoding="utf-8",
    )
...
def matrix_to_svg(matrix, title):
    ...
    parts = [
        ...
        f'{title_height + label_size + cell_size * len(LABELS) / 2})">True label</text>',
    ]
